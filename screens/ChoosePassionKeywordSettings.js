...
const ChoosePassionKeywordSettings = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.choosepassionkeywordsettings}>
      <View style={styles.chosepassionkeyword}>
        ...
        >
          ...
          />
          <Text style={[styles.text6, styles.text6Layout]}>다음</Text>
        </Pressable>
        <Image
...
export default ChoosePassionKeywordSettings;
